...
aveV 		= 10 #average velocity
accA 		= 14 #acceleration
decA 		= -14#deceleration 
maxSpeed 	= 30 #maxspeed of the car
clearance 	= 4.0 # This a magic value don't question why ? Dont Set it below 4

################################behavior of the front car ###############################l
################################dynamics###############################
...
################################discretize###############################
def disS(dis, vdiff, va, maxdis=50, minvdiff=-17, maxvdiff=17, maxva=17):
...
def Vindex(ddis, dvdiff, dva, maxdis= 50, minvdiff=-17, maxvdiff=17, maxva=17): #input must be discretized before hand
